                 ...
                 <div id={style.header}>
                      ...
                      <div id={style.headerHeadingBox}>
                        ...
                        <div id={style.headerMenuBox}>
                            <NavLink exact to="/StudentDashboard"> <span>Dersler</span> </NavLink>
                            <NavLink exact to="/StudentDashboard/Result"> <span>Sonuçlarım</span></NavLink>
                            <NavLink onClick={logout} exact to="/StudentLogin"> <span>Çıkış</span> </NavLink>
                       </div>
