...
import pic4 from "../../../images/sinav_logo.png";
        ...
        return (
            ...
            <div id={style.headerHeadingBox}>
             ...
             <div id={style.headerMenuBox}>
                <NavLink exact to="/AdminDashboard"> <span> Panel</span> </NavLink>
                <a> <span onClick={goToAdminLogin}> Çıkış</span></a>
             </div>
        </div>
                ...
                <div id={style.sideMenubar}>
                         ...
                         <div id={style.sideMenubarList}>
                            <NavLink exact className={style.removeUnderline} to="/AdminDashboard/Subject"> <button > <span>  Dersler </span></button></NavLink>
                            <NavLink exact className={style.removeUnderline} to="/AdminDashboard/Exam"> <button > <span>  Sınavlar </span></button></NavLink>
                            <NavLink exact className={style.removeUnderline} to="/AdminDashboard/Question"> <button > <span>  Sorular</span></button></NavLink>
                            <NavLink exact className={style.removeUnderline} to="/AdminDashboard/Result"> <button > <span>  Sonuçlar </span></button></NavLink>
                            <NavLink exact className={style.removeUnderline} to="/AdminDashboard/StudentList"> <button > <span>  Öğrenci Listesi </span></button></NavLink>
                        </div>
                    </div>
